...
def take_bet(chips):
    while True:
        try:
            ...
            print('Your bet must be an integer, type again : ')
        else:
...
def push(player, dealer):
    print("Dealer and Player have the same value ! Its a draw !")



while True:

    print('\nWelcome to BlackJack Game! Rules are simple : Get as close to 21 as you can without going over!\n\
